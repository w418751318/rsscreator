...
//			String path2 = FilePathEnum.PATH_UPLOAD_NOTICE.getPath();
//			File fi = FileUtil.creatFolder(path, name);
			System.out.print("path============="+path+"====picName:"+picName);
		//	UploadUtil.uploadImages(null,request,path,"10000000");
